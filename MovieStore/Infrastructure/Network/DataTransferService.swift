...
extension DefaultDataTransferService: DataTransferService {
    ...
    public func request<T, E>(with endpoint: E) async throws -> DataTransferResult<T>? where T : Decodable, T == E.Response, E : ResponseRequestable {
        do {
    ...
    public func request<E>(with endpoint: E) async throws -> DataTransferResult<Void>? where E : ResponseRequestable, E.Response == Void {
        do {
            let result = try await self.networkService.request(endpoint: endpoint)
            switch result {
            case .success:
